...
{ 
 assume inv(R,U); 
 assume (_n0 > 0  && _from0 >= 0 && _from0 < replicas&& _to0 >= 0 && _to0 < replicas && _from0 != _to0&& local_rights(_from0, R, U) >= _n0); 
  assume (_n1 > 0  && _id1 >= 0 && _id1 < replicas&& local_rights(_id1, R, U) >= _n1);
 call transfer(_from0,_to0,_n0);
