...
ensures (gteq_store(BookStore, old(BookStore)));
ensures (gteq_store(BookStore, incoming));
ensures (forall v:Store :: gteq_store(v, old(BookStore)) && gteq_store(v , incoming) ==> gteq_store(v, BookStore));
{
assume false;
}