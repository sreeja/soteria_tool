...
const auction_winner1:[AuctionId]BidId;
const auction_prep1:[AuctionId]bool;
const auction_active1:[AuctionId]bool;
const auction_closed1:[AuctionId]bool;
...
assume (forall a:AuctionId :: (0 <= a && a < na) ==> (auction_winner[a] == null) || (auction_winner1[a] == null) || auction_winner[a] == auction_winner1[a]) && (forall b:BidId :: (0 <= b && b < nb) ==> bid_auction[b] == bid_auction1[b] && bid_amount[b] == bid_amount1[b]);
