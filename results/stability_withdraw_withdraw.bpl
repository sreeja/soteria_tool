...
{ 
 assume inv(balances); 
 assume (_value0 > 0 && balances[_client0][me][d] - balances[_client0][me][w] >= _value0 + min); 
  assume (_value1 > 0 && balances[_client1][me][d] - balances[_client1][me][w] >= _value1 + min);
 call withdraw(_client0,_value0);
