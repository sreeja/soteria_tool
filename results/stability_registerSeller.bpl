...
const buyers1:[UserId]bool;
const sellers1:[UserId]bool;
const products1:[ProductId]bool;
const auctions1:[AuctionId]bool;
const auction_seller1:[AuctionId]UserId;
const auction_winner1:[AuctionId]UserId;
const auction_status1:[AuctionId]State;
const lots1:[LotId]bool;
const lot_auction1:[LotId]AuctionId;
const lot_product1:[LotId]ProductId;
const bids1:[BidId]bool;
const bid_auction1:[BidId]AuctionId;
const bid_buyer1:[BidId]UserId;
const bid_amount1:[BidId]int;
procedure registerSeller(sllr:UserId)
modifies sellers;
requires ((sellers[sllr] == false));
ensures ((forall s:UserId :: (s == sllr ==> sellers[s] == true) && (s != sllr ==> sellers[s] == old(sellers)[s])));
...
const _sllr:UserId;
procedure stability_registerSeller()
modifies sellers;
ensures (forall a:AuctionId :: (0 <= a && a < na) ==> (auction_seller[a] == null) || (auction_seller1[a] == null) || auction_seller[a] == auction_seller1[a]) && (forall a:AuctionId :: (0 <= a && a < na) ==> (auction_winner[a] == null) || (auction_winner1[a] == null) || auction_winner[a] == auction_winner1[a]) && (forall l:LotId :: (0 <= l && l < nl) ==> lot_auction[l] == lot_auction1[l] && lot_product[l] == lot_product1[l]) && (forall b:BidId :: (0 <= b && b < nb) ==> bid_auction[b] == bid_auction1[b] && bid_buyer[b] == bid_buyer1[b] && bid_amount[b] == bid_amount1[b]);
{
assume inv(buyers,sellers,products,auctions,auction_seller,auction_status,auction_winner,lots,lot_auction,lot_product,bids,bid_auction,bid_buyer,bid_amount);
assume (forall a:AuctionId :: (0 <= a && a < na) ==> (auction_seller[a] == null) || (auction_seller1[a] == null) || auction_seller[a] == auction_seller1[a]) && (forall a:AuctionId :: (0 <= a && a < na) ==> (auction_winner[a] == null) || (auction_winner1[a] == null) || auction_winner[a] == auction_winner1[a]) && (forall l:LotId :: (0 <= l && l < nl) ==> lot_auction[l] == lot_auction1[l] && lot_product[l] == lot_product1[l]) && (forall b:BidId :: (0 <= b && b < nb) ==> bid_auction[b] == bid_auction1[b] && bid_buyer[b] == bid_buyer1[b] && bid_amount[b] == bid_amount1[b]);
