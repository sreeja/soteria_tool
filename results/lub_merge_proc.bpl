...
procedure lub_merge_proc()
modifies gcounter;
ensures (gteq_counter(gcounter,old(gcounter)));
ensures (gteq_counter(gcounter,_gcounter1));
ensures (forall _gcounter:[ReplicaID]int::gteq_counter(_gcounter,old(gcounter)) && gteq_counter(_gcounter,_gcounter1) ==> gteq_counter(_gcounter,gcounter));
{
