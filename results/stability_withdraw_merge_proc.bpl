...
{ 
 assume inv(balances); 
 assume (_value0 > 0&& balances[_client0][_replica0][d] - balances[_client0][_replica0][w] >= _value0 + min); 
  assume (inv(_balances11));
 call withdraw(_client0,_replica0,_value0);
