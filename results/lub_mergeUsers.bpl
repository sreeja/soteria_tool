...
ensures (gteq_users(Users, old(Users)));
ensures (gteq_users(Users, incoming));
ensures (forall v:[UserId]bool :: gteq_users(v, old(Users)) && gteq_users(v , incoming) ==> gteq_users(v, Users));
{
assume false;
}