...
ensures (gteq(status,winner,bids,_status1,_winner1,_bids1));
ensures (forall _status:bv2, _winner:BidId, _bids:Bid::gteq(_status,_winner,_bids,old(status),old(winner),old(bids)) && gteq(_status,_winner,_bids,_status1,_winner1,_bids1) ==> gteq(_status,_winner,_bids,status,winner,bids));
{
