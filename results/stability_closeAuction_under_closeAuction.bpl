...
procedure stability_closeAuction()
modifies auctions;
...
assume (exists b:BidId :: 0 <= b && b < nb && bids[b][placed] && bids[b][auction] == _auction_identifier && bids[b][amount] > 0);
call closeAuction(_auction_identifier);
