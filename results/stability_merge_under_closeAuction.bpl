...
const _auctions1:Auction;
const _bids1:Bid;
procedure stability_merge()
modifies auctions, bids;
ensures (0 <= auction_identifier && auction_identifier < na && auctions[auction_identifier][reg] && auctions[auction_identifier][status] == active && auctions[auction_identifier][winner] == null) && (exists b:BidId :: 0 <= b && b < nb && bids[b][placed] && bids[b][auction] == auction_identifier && bids[b][amount] > 0);
{
assume inv(auctions,bids) && inv(_auctions1,_bids1);
assume (0 <= auction_identifier && auction_identifier < na && auctions[auction_identifier][reg] && auctions[auction_identifier][status] == active && auctions[auction_identifier][winner] == null) && (exists b:BidId :: 0 <= b && b < nb && bids[b][placed] && bids[b][auction] == auction_identifier && bids[b][amount] > 0);
assume (forall a:AuctionId :: (0 <= a && a < na) ==> ((auctions[a][winner] == _auctions1[a][winner]) || (auctions[a][winner] == null) || (_auctions1[a][winner] == null)));
assume (forall b:BidId :: (0 <= b && b < nb) ==> ((bids[b][auction] == _bids1[b][auction]) || (bids[b][auction] == none) || (_bids1[b][auction] == none)));
assume (forall b:BidId :: (0 <= b && b < nb && bids[b][placed] && _bids1[b][placed]) ==> (_bids1[b][auction] == bids[b][auction] && bids[b][amount] == _bids1[b][amount]));
assume (forall a:AuctionId :: (0 <= a && a < na && auctions[a][status] == closed) ==> (forall b:BidId :: (0 <= b && b < nb && _bids1[b][placed] && _bids1[b][auction] == a && auctions[a][winner] != b) ==> ((_bids1[b][amount] < _bids1[auctions[a][winner]][amount]) || (_bids1[b][amount] == _bids1[auctions[a][winner]][amount] && auctions[a][winner] < b))));
assume (forall a:AuctionId :: (0 <= a && a < na && _auctions1[a][status] == closed) ==> (forall b:BidId :: (0 <= b && b < nb && bids[b][placed] && bids[b][auction] == a && _auctions1[a][winner] != b) ==> ((bids[b][amount] < bids[_auctions1[a][winner]][amount]) || (bids[b][amount] == bids[_auctions1[a][winner]][amount] && _auctions1[a][winner] < b))));
call merge(_auctions1, _bids1);
