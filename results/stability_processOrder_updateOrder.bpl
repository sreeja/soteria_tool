...
{ 
 ...
 assume (UserOrders[_id0][placed] == true && UserOrders[_id0][processed] == false && UserOrders[_id0][cancelled] == false&& (forall b:ISBN :: BookStore[b][P][_storeloc0] - BookStore[b][N][_storeloc0] >= UserOrders[_id0][items][b])); 
  assume (_qty1 >= 0 && UserOrders[_id1][created] == true && UserOrders[_id1][placed] == false && UserOrders[_id1][user] == _usr1);
 call processOrder(_id0,_storeloc0);
