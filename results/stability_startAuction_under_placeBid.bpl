...
modifies bids;
ensures 0 <= auction_identifier && auction_identifier < na && auctions[auction_identifier][reg] && auctions[auction_identifier][status] == prep && auctions[auction_identifier][winner] == null;
{
assume inv(auctions,bids);
assume 0 <= auction_identifier && auction_identifier < na && auctions[auction_identifier][reg] && auctions[auction_identifier][status] == prep && auctions[auction_identifier][winner] == null;
