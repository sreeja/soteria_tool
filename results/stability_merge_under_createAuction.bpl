...
modifies auctions, bids;
ensures 0 <= auction_identifier && auction_identifier < na && !auctions[auction_identifier][reg] && auctions[auction_identifier][status] == invalid && auctions[auction_identifier][winner] == null;
{
assume inv(auctions,bids) && inv(_auctions1,_bids1);
assume 0 <= auction_identifier && auction_identifier < na && !auctions[auction_identifier][reg] && auctions[auction_identifier][status] == invalid && auctions[auction_identifier][winner] == null;
